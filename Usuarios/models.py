...
class Pessoa(models.Model):
    ...
    naturalidade = models.CharField(verbose_name = "Naturalidade", max_length = 194, blank=False, null=False)
    pais = models.CharField(verbose_name = "País",max_length= 194, blank=False, null=False)
    escolaridade = models.CharField(verbose_name = "Escolaridade:", max_length = 30, choices= ESCOLARIDADE)
    status = models.CharField(verbose_name="Genero",max_length=10,choices=STATUS_GENERO)
    email = models.EmailField(verbose_name = "E-mail:", unique=True, blank=False, null=False)
    telefone_celular = models.CharField(verbose_name = "Número de telefone", max_length = 19,unique=False, blank=False, null=False)
    cpf = models.CharField(verbose_name = "CPF:", max_length= 11, unique=True, blank=False, null=False)
    nascimento = models.DateField(verbose_name = "Data de nascimento:", max_length = 10)
    estado_civil = models.CharField(verbose_name = "Estado civil:", max_length = 40,choices=ESTADO_CIVIL)
    ...
    numero = models.CharField(verbose_name = "Número da residencia:", max_length = 194, blank=False, null=False)
